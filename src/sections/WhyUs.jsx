...
const reasons = [
  ...
  },
  {
    ...
    desc: 'Most clients achieve certification in 45–90 days. Our structured process eliminates the wasted time that bogs down other consultancies.',
  },
  {
    icon: Users,
...
function ReasonCard({ reason, idx }) {
  ...
  return (
    <div
      ref={ref}
      className={`reveal reveal-delay-${idx + 1} flex gap-5`}
    >
              ...
              <div className="relative rounded-3xl bg-gradient-to-br from-brand-50 to-brand-100 border border-brand-200 p-10 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {[
                      { n: '100+', l: 'Certified clients' },
                      { n: '98%',  l: 'Pass rate' },
                      { n: '45d',  l: 'Avg. time to cert' },
                      { n: '15+',  l: 'Years experience' },
                    ].map(({ n, l }) => (
                      <div key={l} className="bg-white rounded-2xl p-4 shadow-sm">
                        <div className="text-[1.7rem] font-extrabold text-[#0d98cd] leading-none mb-1">{n}</div>
                  ...
                  <div className="bg-white rounded-2xl p-4 shadow-sm">
                    <p className="text-[0.72rem] font-semibold uppercase tracking-wider text-gray-400 mb-3">Standards we deliver</p>
                    <div className="flex flex-wrap gap-2">
                      {['ISO 9001', 'ISO 27001', 'ISO 45001', 'ISO 14001', 'IMS'].map(s => (
                        <span key={s} className="text-[0.78rem] font-semibold text-[#0d98cd] bg-brand-100 border border-brand-200 rounded-full px-3 py-1">
                          {s}
                        </span>
                      ))}
                    </div>
